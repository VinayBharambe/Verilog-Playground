...
HD_PWD='C:/Users/Admin/Vivado_Udemy/Design Flow Part 1/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log project1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source project1.tcl
