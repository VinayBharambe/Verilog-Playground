...
HD_PWD='C:/Users/Admin/Vivado_Udemy/Design Flow Part 2/BRAM_MUX/BRAM_MUX.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bram_mux.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bram_mux.tcl
