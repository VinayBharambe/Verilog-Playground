...
HD_PWD='C:/Users/Admin/Vivado_Udemy/Design Flow Part 2/BRAM_MUX/BRAM_MUX.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log bram_mux.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source bram_mux.tcl -notrace
