...
HD_PWD='C:/Users/Admin/Vivado_Udemy/Design Flow Part 2/Test5- 8 bit MUX- Nexys DDR4/Test5- 8 bit MUX- Nexys DDR4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log m81.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source m81.tcl -notrace
