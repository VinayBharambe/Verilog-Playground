...
HD_PWD='C:/Users/Admin/Vivado_Udemy/Design Flow Part 2/Test5- 8 bit MUX- Nexys DDR4/Test5- 8 bit MUX- Nexys DDR4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log m81.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source m81.tcl
