...
HD_PWD='C:/Users/Admin/Vivado_Udemy/Design Flow Part 1/Assignment1-HalfAdder/Assignment1-HalfAdder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log HA.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source HA.tcl
