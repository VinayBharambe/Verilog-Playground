...
HD_PWD='C:/Users/Admin/Vivado_Udemy/Design Flow Part 1/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log project1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source project1.tcl -notrace
